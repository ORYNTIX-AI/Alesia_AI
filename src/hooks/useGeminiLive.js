...
3. До прихода служебного веб-контекста не обещай, что сайт уже открывается, и не говори "открываю сайт", "уже открываю" или "сейчас открою сайт".
4. Пока не пришёл служебный веб-контекст, можно сказать только нейтральную короткую фразу вроде "Секунду, проверяю.".
5. Не утверждай, что сайт уже открыт или прочитан, пока не пришёл служебный веб-контекст.
