...
3. `v0.0.14` is deployed after the Gemini turn lifecycle repair; direct production WebSocket smoke passed for Gemini Live and Yandex Realtime.
4. Re-check on a phone:
